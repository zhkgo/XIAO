...
class Experiment:
    def __init__(self):
        self.CHANNELS = [
            ['Fp1', 'Fp2', 'F3', 'F4', 'F7', 'F8', 'FC1', 'FC2', 'FC5', 'FC6', 'Cz', 'C3', 'C4', 'T7', 'T8', 'CP1',
             'CP2', 'CP5', 'CP6', 'Pz', 'P3', 'P4', 'P7', 'P8', 'POz', 'PO3', 'PO4', 'PO5', 'PO6', 'Oz', 'O1', 'O2',
             'ref'],  # ref 参考电极
    ...
    def setParameters(self, sessions: int, fitSessions: int, trials: int, duration: int, interval: int, tmin: int,
                      tmax: int, device: int,skipinterval=0):
